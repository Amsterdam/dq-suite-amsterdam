...
class TestCreateParameterListFromResult:
    def test_create_parameter_list_from_results_with_batch_id(self):
        result = {
            "kwargs": {"param1": 10, "param2": "example", "batch_id": 123}
        }

        expected_output = [{"param1": 10, "param2": "example"}]
        assert create_parameter_list_from_results(result) == expected_output

    def test_create_parameter_list_from_results_without_batch_id(self):
        result = {"kwargs": {"param1": 10, "param2": "example"}}
