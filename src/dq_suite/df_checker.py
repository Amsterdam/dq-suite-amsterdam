...
def df_check(
    ...
    and returns a JSON string with the DQ results with different dataframes in
    results dict, and returns different dfs as specified using Data Quality
    rules
    ...
    :return: A dictionary of Data Quality results for each DataFrame,
             along with metadata DataFrames:  brontabel_df, bronattribute_df,
             dqRegel_df .
    ...
    for df in dfs:
        ...
        for rule in matching_rules:
            ...
            for key, value in output.items():
                ...
                result_dqAfwijking = extract_dq_afwijking_data(
                    df_name, result, df, unique_identifier
                )
