...
def normalize_validation_parameters(params: dict) -> dict:
    """
    Normalize parameters for hashing & writing:
    - round numeric fields
    - sort keys alphabetically
    """
    params = round_numeric_params(params)
...
def get_single_expectation_afwijking_data(
    ...
    if unexpected_rows:
            ...
            extracted_data.append(
                {
                    ...
                    "afwijkendeAttribuutWaarde": mask_value(result_dict.get("observed_value", []), attribute),
                    "dqDatum": run_time,
                    "regelNaam": rule_name,
                    "regelParameters": afwijking_parameters,
                    "bronTabelId": table_id,
        ...
        raise ValueError(
            ...
            "Expected 'unexpected_rows' or 'observed_value' or 'unexpected_list' key."
        )
    return extracted_data
