...
### Added
- Added team metadata to the draft data quality rules JSON generated from profiling results.
  `"team": {
          "teamid": "dpxx",
          "teamname": "xx team",
...
- Added `attribuutNaam` column in profilingattribuut table.

### Changed
- Improved profiling configuration by clarifying the distinction between input dataset and output catalog
...
### Added
- Added negative unit test scenarios for geometry validation rules, covering failure cases.
